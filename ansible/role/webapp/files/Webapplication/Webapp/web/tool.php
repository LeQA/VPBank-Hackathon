...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm fixed-top">
        <a class="navbar-brand" href="/wall.php">
            <h2 class="text-primary font-weight-bolder">Message Board</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/wall.php">Home</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="/tool.php">Tool<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <!-- Add a separation between the navigation and the container -->
    ...
    <div class="container">
        <div class="page-header" id="banner">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="cover-heading">Network tool</h1>
...
<script>
    ...
    function logSubmit(event) {
        ...
        $.post('tool.php',$(frm_tool).serialize(),function(data){
